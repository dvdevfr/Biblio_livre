...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/library.js":[function(require,module,exports) {
"use strict";
...
var Library = /*#__PURE__*/function () {
  function Library(DOMContainer) {
    _classCallCheck(this, Library);
    _defineProperty(this, "books", void 0);
    _defineProperty(this, "DOMContainer", void 0);
    _defineProperty(this, "sortSelectedOption", void 0);
    this.books = [];
  ...
  _createClass(Library, [{
    ...
    value: function updateDOM() {
      ...
      this.books.forEach(function (e) {
        return _this.DOMContainer.appendChild(e.DOMElement);
      });
    }
  }, {
    key: "sortByTitle",
...
},{}],"assets/js/book.js":[function(require,module,exports) {
"use strict";
...
var Book = /*#__PURE__*/function () {
  function Book(title, imgSrc, author, library) {
    _classCallCheck(this, Book);
    _defineProperty(this, "library", void 0);
    _defineProperty(this, "title", void 0);
    _defineProperty(this, "imgSrc", void 0);
  ...
  _createClass(Book, [{
    ...
    value: function generateTemplate() {
      ...
      removeBook.addEventListener("click", function () {
        _this.library.deleteBook(_this);
      });
...
var sortByTitleBtn = document.getElementById("sortByTitle");
var sortByAuthorBtn = document.getElementById("sortByAuthor");
var library = new _library.default(cardContainer);
form.addEventListener("submit", function (e) {
  e.preventDefault();
  var formData = new FormData(e.target);
  var book = new _book.default(formData.get("title"), formData.get("imgSrc"), formData.get("author"), library);
  library.addBook(book);
  library.updateDOM();
  e.target.reset();
});
sortByTitleBtn.addEventListener("click", function (e) {
  library.sortByTitle();
  library.updateDOM();
});
sortByAuthorBtn.addEventListener("click", function (e) {
  library.sortByAuthor();
  library.updateDOM();
});
},{"./library":"assets/js/library.js","./book":"assets/js/book.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
